# Generated by Django 5.0.3 on 2024-04-24 11:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_date', models.DateField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reservation_date', models.DateField(blank=True, default=None, null=True)),
                ('return_date', models.DateField(blank=True, default=None, null=True)),
